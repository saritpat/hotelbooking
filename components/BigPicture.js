    ...
    return (
        <div className="fixed right-0 w-[982px]">
            <div className="absolute">
                <Image src={"/bigpic.png"} width={982} height={1080} alt="big picture" />
            </div>
            <div className="absolute">
                <Image src={"/bgbigpic.png"} width={982} height={1080} alt="background" />
                ...
                <div className="fixed right-0 top-1/2">
                    <Image src="/pic-svg.svg" width={100} height={100} alt="arrow-icon" />
                </div>
